...
class TestRunOfflineEvents(unittest.TestCase):
    def test_run_events(self):
        """
        Try logging events and retrieving them from an offline run
        """
        ...
        data_compare = [
            {"timestamp": "2022-01-03 16:42:30.849617", "message": "test-event-1"},
